...
for i in range(n):
    ...
    tikz.circle(point, 2.8, options="color=" + rainbow_colors(i + 3)).shift(0, -2)
    # tikz.circle(point, 3.0, options="color=" + rainbow_colors(i + 3)).shift(0, -2)
    tikz.circle(point, 3.2, options="color=" + rainbow_colors(i + 3)).shift(0, -2)
    # tikz.circle(point, 3.4, options="color=" + rainbow_colors(i + 3)).shift(0, -2)
